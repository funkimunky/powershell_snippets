...
Get-InstalledApplications | Select-Object {IdentifyingNumber, DisplayName, InstallLocation} | Format-Table IdentifyingNumber, DisplayName, InstallLocation -AutoSize